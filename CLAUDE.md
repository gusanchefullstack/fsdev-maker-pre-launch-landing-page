...
# Design
- Consider the figma-design file (*.fig) as source or truth for css styles, spacing, fonts, responsive designs. The figma design is included en in /figma-design and added to the drafts in figma desktop app.
...
@frontendmentor-submitter Submit the project

# Fixing issues of FrontendMentor.io
@frontend-mentor-issue-fixer